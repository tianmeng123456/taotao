    ...
    <ul class="fr topTh">
      <li class="login" id="login">
      	<span id="loginbar" style="margin-right: 15px;">
	      	<a href="http://localhost:8095/page/login?returnUrl=http%3A//www.e3mall.cn/">请登录</a>
      	</span>
      	<a href="http://localhost:8095/page/register?returnUrl=http%3A//www.e3mall.cn/">免费注册</a>
      </li>
